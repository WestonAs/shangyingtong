 ...
 */
public class ReloadableSqlMapClientFactoryBean implements FactoryBean, InitializingBean {
	...
	public ReloadableSqlMapClientFactoryBean() {
...
//			InputStream is = configLocations[i].getInputStream();
			InputStream is = new FileSystemResource(configLocations[i].getFile().getPath()).getInputStream();
			try {
