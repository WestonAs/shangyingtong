...
public class BigDecimalCompare extends BaseCompare {

    public BigDecimalCompare() {
    }
    ...
    public int compare(String stringLeft, String stringRight) {
        final double doubleLeft = NumberUtils.createBigDecimal(stringLeft).doubleValue();
        final double doubleRight = NumberUtils.createBigDecimal(stringRight).doubleValue();
        return NumberUtils.compare(doubleLeft, doubleRight);
    }
