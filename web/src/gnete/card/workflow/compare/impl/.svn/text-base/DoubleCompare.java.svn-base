...
public class DoubleCompare extends BaseCompare {
    ...
    public int compare(String stringLeft, String stringRight) {
        final double doubleLeft = NumberUtils.createDouble(stringLeft).doubleValue();
        final double doubleRight = NumberUtils.createDouble(stringRight).doubleValue();
