...
public class ShortCompare extends BaseCompare {
    public ShortCompare() {
    }
    ...
    public int compare(String stringLeft, String stringRight) {
        final int shortLeft = NumberUtils.createNumber(stringLeft).intValue();
        final int shortRight = NumberUtils.createNumber(stringRight).intValue();
        return NumberUtils.compare(shortLeft, shortRight);
    }
}
