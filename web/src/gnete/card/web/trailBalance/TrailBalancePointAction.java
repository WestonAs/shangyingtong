...
import gnete.card.entity.TrailBalancePoint;
import gnete.card.entity.flag.BalanceFlag;
import gnete.card.entity.type.RoleType;
import gnete.card.web.BaseAction;
import gnete.etc.BizException;

public class TrailBalancePointAction extends BaseAction{
	...
	private TrailBalancePoint trailBalancePoint;
	...
	public String execute() throws Exception {
		...
		if (trailBalancePoint != null) {
			params.put("settDate", this.trailBalancePoint.getSettDate());
			params.put("cardIssuer", this.trailBalancePoint.getCardIssuer());
			params.put("balanceFlag", this.trailBalancePoint.getBalanceFlag());
		}
		// 当前登录用户所属或所管理的发卡机构列表
		...
		this.page = this.trailBalancePointDAO.findTrailBalancePoint(params, this.getPageNumber(), this.getPageSize());	
	...
	public TrailBalancePoint getTrailBalancePoint() {
		return trailBalancePoint;
	}

	public void setTrailBalancePoint(TrailBalancePoint trailBalancePoint) {
		this.trailBalancePoint = trailBalancePoint;
	}
