 ...
 * 
  * @Project: Card
  * @File: CardProxySellDepositReportImpl.java
  * @See:
  * @description：
  *    <li>售卡代理——售卡充值日结算报表</li>
  * @author: aps-zbw
  * @modified:
  ...
  * @version:  V1.0
 */
@Service("cardProxySellDepositReport")
public class CardProxySellDepositReportImpl extends AbstractCardReportLoadImpl{
