 ...
 *
 * @description: 运营机构单机产品POS缴费月收入汇总报表（套餐费）
 *
 ...
 */
@Service("singleProductFenzhiPOSMonthRev")
public class SingleProductFenzhiPOSMonthRevImpl extends AbstractCardReportLoadImpl {
	
	/** 运营机构单机产品POS缴费月收入汇总报表（套餐费） */
	private final String FENZHI_POSPLAN_REVSUM_FILE = "/singleProduct/fenzhiPOSPlanRevMonthSum.raq";

	private final String REPORT_ERROR_MSG = "没有权限查看运营机构单机产品POS缴费月收入汇总报表（套餐费）!";
