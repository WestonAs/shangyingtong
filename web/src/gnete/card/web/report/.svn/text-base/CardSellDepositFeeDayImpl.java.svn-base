...
import gnete.card.entity.type.report.CardSellDepositFeeDSetType;
 ...
 *
 * @description: 发卡机构售卡充值销售手续费日统计报表
 *
 ...
 */
@Service("cardSellDepositFeeDayImpl")
public class CardSellDepositFeeDayImpl extends AbstractCardReportLoadImpl {
	
	private final String REPORT_ERROR_MSG = "没有权限查看发卡机构售卡充值销售手续费日统计报表!";
	...
	protected void processUserLoad(HttpServletRequest request, UserInfo userInfo) {
		...
		request.setAttribute("reportTypeList", CardSellDepositFeeDSetType.getAll());
