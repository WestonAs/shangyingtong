 ...
 *
 * @description: 运营中心单机产品POS缴费日收入汇总报表（套餐费）
 *
 ...
 */
@Service("singleProductCenterPOSDayRev")
public class SingleProductCenterPOSDayRevImpl extends AbstractCardReportLoadImpl {
	
	/** 运营中心单机产品POS缴费日收入汇总报表（套餐费）*/
	private final String CENTER_POSPLAN_REVSUM_FILE = "/singleProduct/centerPOSPlanRevSum.raq";

	private final String REPORT_ERROR_MSG = "没有权限查看运营中心单机产品POS缴费日收入汇总报表（套餐费）!";
