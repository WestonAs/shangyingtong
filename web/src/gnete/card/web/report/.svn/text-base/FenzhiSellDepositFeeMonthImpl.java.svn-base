 ...
 *
 * @description: Web运营机构售卡充值手续费月统计报表
 *
 ...
 */
@Service("fenzhiSellDepositFeeMonthImpl")
public class FenzhiSellDepositFeeMonthImpl extends AbstractCardReportLoadImpl {
	
	/** Web运营机构售卡充值手续费月统计报表 */
	private final String CHL_SellDeposit_Fee_MSet_FILE = "/fenzhi/chlSellDepositFeeMSet.raq";

	private final String REPORT_ERROR_MSG = "没有权限查看Web运营机构售卡充值手续费月统计报表!";
	...
	protected void processUserLoad(HttpServletRequest request, UserInfo userInfo) {
		...
		if (StringUtils.equals(loginRoleType, RoleType.CENTER.getValue())
			...
			reportFile = CHL_SellDeposit_Fee_MSet_FILE;
		}
