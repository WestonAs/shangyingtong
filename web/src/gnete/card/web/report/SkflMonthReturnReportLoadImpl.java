 ...
 * 
 * @Project: Card
 * @File: SkflMonthReturnReportLoadImpl.java
 * @See:
 * @description：
 *    <li>处理售卡返利月报表</li>
 *    <li>还需要区分交易类型:是售卡交易还是充值交易(这个对应着不同的查询)</li>
 * @author: aps-zbw
 * @modified:
 ...
 * @version: V1.0
 */
@Service("skflMonthReportLoad")
public class SkflMonthReturnReportLoadImpl extends AbstractCardReportLoadImpl {
	...
	private final String REPORT_PROXY_FILE = "/skdlFlMonthDs.raq";
	...
	private String[] getTopLevelQueryParams(String roleType, String reportType, String[] params) throws Exception{
		 ...
		 */
		else if (StringUtils.equals(reportType, SkflReportType.SELL.getValue())) {
