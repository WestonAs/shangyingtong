...
/**
 * @File: CardSellDepositDSetImpl.java
 *
 * @description: 发卡机构角色菜单下的售卡充值日结算报表
 *
 ...
 * @since 1.0 2011-6-22
 */
@Service("cardSellDepositDSetImpl")
public class CardSellDepositDSetImpl extends AbstractCardReportLoadImpl {
	
	private final String REPORT_ERROR_MSG = "没有权限查看发卡机构报表!";
