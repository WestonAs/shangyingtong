				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
							<s:select name="cardInfo.cardClass" list="cardClassList" headerKey="" headerValue="--请选择--" listKey="cardTypeCode" listValue="cardTypeName"></s:select>
							</td>
						</tr>
						<tr>
					...
					<s:token name="_TOKEN_PRECARD_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/preCard/detail.do?cardInfo.cardId=${cardId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
