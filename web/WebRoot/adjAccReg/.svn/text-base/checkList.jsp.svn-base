...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${adjAccId}"/></td>	
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/adjAccReg/checkDetail.do?adjAccReg.adjAccId=${adjAccId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="adjAccAdapter" returnUrl="/adjAccReg/checkList.do"><s:token name="_TOKEN_ADJACCREG_CHECKLIST"/></f:workflow>
		</div>
