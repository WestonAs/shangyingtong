	...
	<body>
				...
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="searchForm" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select name="mset.merchProxy" headerKey="" headerValue="--请选择--" list="saleList" listKey="branchCode" listValue="branchName"></s:select>
							</td>
					...
					<s:token name="_TOKEN_VERIFY_MERCH_PROXY_SHARES_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">实际分润</td>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<s:if test="chkStatus==01 || chkStatus==04">
				  	<span class="redlink">
				  		<f:pspan pid="verifymerchproxyshares_verify">
				  			<f:link href="/verify/verifyMerchProxyShares/showVerify.do?mset.branchCode=${branchCode}&mset.merchId=${merchId}&mset.feeMonth=${feeMonth}&mset.merchProxy=${merchProxy}">核销</f:link>
				  		</f:pspan>
				  	</span>
				</s:if>
			  </td>
