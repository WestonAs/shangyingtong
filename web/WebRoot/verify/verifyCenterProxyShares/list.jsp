	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					...
					<s:token name="_TOKEN_VERIFY_CENTER_PROXY_SHARE_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">运营机构分润</td>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<s:if test="chkStatus==01 || chkStatus==04">
				  	<span class="redlink">
				  		<f:pspan pid="verifycenterproxyshares_verify">
				  			<f:link href="/verify/verifyCenterProxyShares/showVerify.do?mset.branchCode=${branchCode}&mset.proxyId=${proxyId}&mset.feeMonth=${feeMonth}">核销</f:link>
				  		</f:pspan>
				  	</span>
				</s:if>
			  </td>
