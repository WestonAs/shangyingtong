				...
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="searchForm" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select name="mset.chlCode" headerKey="" headerValue="--请选择--" list="manageList" listKey="branchCode" listValue="branchName"></s:select>
							</td>
					...
					<s:token name="_TOKEN_VERIFY_RELEASE_CARD_FEE_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<s:if test="chkStatus==01">
				  	<span class="redlink">
				  		<f:pspan pid="verifyreleasecardfee_verify">
				  			<f:link href="/verify/verifyReleaseCardFee/showVerify.do?mset.branchCode=${branchCode}&mset.feeMonth=${feeMonth}">核销</f:link>
				  		</f:pspan>
				  	</span>
				</s:if>
			  </td>
