	...
	<body>
		...
		<div class="userbox">
			...
			<s:form action="verify.do" id="inputForm" cssClass="validate">
				...
				<s:hidden name="mset.chlCode"></s:hidden>
				...
				<table class="form_grid detail_tbl" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						...
						<td height="30">
							...
							<input type="button" value="返回" name="escape" onclick="gotoUrl('/verify/verifyBranchShares/list.do?goBack=goBack')" class="ml30" />
						</td>
					</tr>
				</table>
				<s:token name="_TOKEN_VERIFY_BRANCH_SHARES_VERIFY"/>
			</s:form>
		</div>
