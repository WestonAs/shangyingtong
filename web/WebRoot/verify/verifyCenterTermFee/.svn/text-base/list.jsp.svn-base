	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					...
					<s:token name="_TOKEN_VERIFY_CENTER_TERMFEE_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">机具出机方</td>
			   ...
			   <td align="center" nowrap class="titlebg">运营中心分润</td>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<s:if test="chkStatus==01 || chkStatus==04">
				  	<span class="redlink">
				  		<f:pspan pid="verifycentertermfee_verify">
				  			<f:link href="/verify/verifyCenterTermFee/showVerify.do?mset.branchCode=${branchCode}&mset.termCode=${termCode}&mset.feeMonth=${feeMonth}">核销</f:link>
				  		</f:pspan>
				  	</span>
				</s:if>
			  </td>
