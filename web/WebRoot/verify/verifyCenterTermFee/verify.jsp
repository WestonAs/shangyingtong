		...
		<div class="userbox">
			...
			<s:form action="verify.do" id="inputForm" cssClass="validate">
				...
				<table class="form_grid detail_tbl" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						<td width="120" height="30" align="right">机具出机方</td>
						<td>
							${mset.termName}
						</td>
					</tr>
					...
					<tr>
						...
						<td height="30">
							...
							<input type="button" value="返回" name="escape" onclick="gotoUrl('/verify/verifyCenterTermFee/list.do?goBack=goBack')" class="ml30" />
						</td>
					</tr>
				</table>
				<s:token name="_TOKEN_VERIFY_CENTER_TERMFEE_VERIFY"/>
			</s:form>
		</div>
