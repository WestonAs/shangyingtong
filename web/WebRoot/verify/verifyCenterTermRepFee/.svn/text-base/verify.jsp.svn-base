	...
	<body>
		...
		<div class="userbox">
			...
			<s:form action="verify.do" id="inputForm" cssClass="validate">
				...
				<s:hidden name="mset.termCode"></s:hidden>
				...
				<table class="form_grid detail_tbl" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						<td width="120" height="30" align="right">机具维护方</td>
						<td>
							${mset.termName}
						</td>
					</tr>
					...
					<tr>
						<td width="120" height="30" align="right">本期金额</td>
						<td>
							${fn:amount(mset.feeAmt)}
						</td>
					</tr>
					<tr>
						<td width="120" height="30" align="right">运营中心实际分润金额</td>
						<td>
					...
					<tr>
						...
						<td>
							<s:textfield name="mset.recvAmt" cssClass="readonly" readonly="true"></s:textfield>
						</td>
					</tr>
					<tr>
						...
						<td height="30">
							...
							<input type="button" value="返回" name="escape" onclick="gotoUrl('/verify/verifyCenterTermRepFee/list.do?goBack=goBack')" class="ml30" />
						</td>
					</tr>
				</table>
				<s:token name="_TOKEN_VERIFY_CENTER_TERMREPFEE_VERIFY"/>
			</s:form>
		</div>
