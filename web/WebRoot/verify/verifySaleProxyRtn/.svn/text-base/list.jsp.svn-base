	...
	<body>
			...
			<div class="contentb">
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="searchForm" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>售卡代理商返利核销</caption>
						<tr>
							<td width="80" height="30" align="right">发卡机构</td>
							<td>
								<s:select name="mset.orgId" headerKey="" headerValue="--请选择--" list="branchList" listKey="branchCode" listValue="branchName"></s:select>
							</td>
							<td width="80" height="30" align="right">售卡代理</td>
							<td>
								<s:select name="mset.proxyId" headerKey="" headerValue="--请选择--" list="saleList" listKey="branchCode" listValue="branchName"></s:select>
							</td>
					...
					<s:token name="_TOKEN_VERIFY_SALE_PROXY_RTN_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">售卡代理</td>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<s:if test="chkStatus==01 || chkStatus==04">
				  	<span class="redlink">
				  		<f:pspan pid="verifysaleproxyrtn_verify">
				  			<f:link href="/verify/verifySaleProxyRtn/showVerify.do?mset.proxyId=${proxyId}&mset.orgId=${orgId}&mset.feeMonth=${feeMonth}&mset.curCode=${curCode}">核销</f:link>
				  		</f:pspan>
				  	</span>
				</s:if>
			  </td>
