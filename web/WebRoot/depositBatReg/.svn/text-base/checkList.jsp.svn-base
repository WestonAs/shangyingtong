...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/depositBatReg/checkDetail.do?depositBatReg.depositBatchId=${depositBatchId}">明细</f:link>
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<f:workflow adapter="depositBatchAdapter" returnUrl="/depositBatReg/checkList.do"><s:token/></f:workflow>
		</div>
