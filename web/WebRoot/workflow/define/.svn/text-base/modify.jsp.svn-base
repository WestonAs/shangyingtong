			...
			<div class="contentb">
				<s:form action="modify.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" id="idWorkflowDefineTbl" 
						width="30%" border="0" cellspacing="3" cellpadding="0">
						<tr>
						   <td align="center" nowrap class="titlebg">序号</td>
						   <td align="center" nowrap class="titlebg">节点名称</td>
						</tr>
						<s:iterator value="defaultNodeList" status="status">
						    <tr id="idDetail_<s:property value="#status.index"/>">
								<td align="center" >
									<s:property value="#status.index"/>
								</td>
								<td align="center">
									<input type="text" name="names" value="${nodeName}" />
								</td>
						    </tr>
						</s:iterator>
					</table>
					...
					<s:token name="_TOKEN_WORKFLOW_DEFINE_MODIFY"/>
				</s:form>
			</div>
