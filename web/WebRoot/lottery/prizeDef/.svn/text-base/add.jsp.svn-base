...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function loadSubClass(value){
			$('#subClassId').load(CONTEXT_PATH + '/lottery/prizeDef/getSubClassList.do', {'ruleType':value, 'callId':callId()});
		}
		</script>
	</head>
				...
				<s:form action="add.do" id="inputForm" cssClass="validate" >
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select name="prizeDef.drawId" list="drawList" headerKey="" headerValue="--请选择--" listKey="drawId" listValue="drawName" cssClass="{required:true}"></s:select>
								<span class="field_tipinfo">请选择抽奖活动</span>
							</td>
							
<%--							<td width="80" height="30" align="right">奖项编号</td>--%>
<%--							<td>--%>
<%--								<s:textfield name="prizeDef.prizeNo" cssClass="{required:true, num:true}" maxlength="6"/>--%>
...
<%--							</td>--%>
						...
						<tr>
							...
							<td height="30" colspan="3">
								...
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/lottery/prizeDef/list.do')" class="ml30" />
							</td>
						</tr>
					</table>
