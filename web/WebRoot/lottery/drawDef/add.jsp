					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
							    ...
							    <span class="field_tipinfo">请输入抽奖方法</span>
							</td>
						...
						<tr>
							...
							<td height="30" colspan="3">
								...
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/lottery/drawDef/list.do')" class="ml30" />
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_LOTTER_DRAW_DEF_ADD"/>
					<span class="note_div">注释</span>
					<ul class="showli_div">
						<li class="showli_div">一.现场抽奖：先定义抽奖活动-审核-再录入抽奖人信息-定义奖品-抽奖-领取奖品</li>
						<li class="showli_div">二.即刷即中：先定义抽奖活动-审核-定义奖品-pos交易（是否中奖）-中奖后领取奖品</li>
						<li class="showli_div">三.即刷即中（概率折算方法）：</li>
						<li class="showli_div">'0': 表示按固定倍数（最小倍数），		即，抽奖的概率为prob_min的值</li>
						<li class="showli_div">'1': 大等于基准金额后固定倍数，		即，交易金额必须大于 ref_amt的值时，抽奖的概率为prob_min（最小倍率）的值</li>
						<li class="showli_div">'2':  金额/按参考金额倍		即，交易金额除以参考金额获得概率，</li>
						<li class="showli_div">若该概率值小于prob_min（最小倍率），则选择prob_min的值乘以prob_base（基准概率）当做抽奖的概率值</li>
						<li class="showli_div">若该概率的值大于prob_max（最大倍率），则选择prob_max的值乘以prob_base（基准概率） 当做抽奖的概率值</li>
						<li class="showli_div">'3':  2＋1倍		即，若交易金额小于ref_amt参考金额，抽奖概率为0,暂时和方法2一致</li>
					</ul>
				</s:form>
			</div>
