...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${drawId}"/></td>
			  <td nowrap>${drawId}</td>
		...
		<f:workflow adapter="lotteryAdapter" returnUrl="/lottery/drawDef/checkList.do"><s:token name="_TOKEN_LOTTER_DRAW_DEF_CHECKLIST"/></f:workflow>
		</div>
