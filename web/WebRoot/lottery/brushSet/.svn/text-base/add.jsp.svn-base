				...
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select id="drawId_Id" name="brushSet.drawId" list="drawDefList" headerKey="" headerValue="--请选择--" listKey="drawId" listValue="drawName" cssClass="{required:true}"></s:select>
					...
					<s:token name="_TOKEN_LOTTER_BRUSH_SET_ADD"/>
				</s:form>
			</div>
