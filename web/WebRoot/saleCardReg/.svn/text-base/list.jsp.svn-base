...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			var actionName = 'list' + '${actionSubName}' + '.do'
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield name="saleCardReg.saleBatchId" cssClass="{digitOrLetter:true}"/>
							</td>							
							<td align="right">卡号</td>
							<td>
								<s:textfield name="saleCardReg.cardId" cssClass="{digitOrLetter:true}"/>
							</td>
						...
						<tr>
							...
							<td height="30" colspan="4">
								...
								<f:pspan pid="saleCard${actionSubName}_add"><input style="margin-left:30px;" type="button" value="新增" onclick="javascript:gotoUrl('/saleCardReg/showAdd${actionSubName}.do');" id="input_btn3"  name="escape" /></f:pspan>
							</td>
							<td><s:hidden name="actionSubName" ></s:hidden></td>
						</tr>
					</table>
					<s:token name="_TOKEN_SALE_CARD_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/saleCardReg/detail.do?saleCardReg.saleBatchId=${saleBatchId}">查看</f:link>			  		
			  	</span>
			  	<s:if test="isPresell==true" > <s:if test="unActivatedLabel.equals(status)" >
				  	<f:pspan pid="saleCardPre_activate"><f:link href="/saleCardReg/showActivate.do?saleCardReg.saleBatchId=${saleBatchId}">激活</f:link></f:pspan>
			  	</s:if></s:if>
			  </td>
			</tr>
			</s:iterator>
