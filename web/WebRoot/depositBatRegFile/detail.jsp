...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption><s:text name="cardTypeCode.cardTypeName"/>充值信息<span class="caption_title"> | <s:if test="actionSubName == null"><f:link href="/depositBatRegFile/list.do?goBack=goBack">返回列表</f:link></s:if><s:else><f:link href="/depositBatReg/listPreFile.do">返回列表</f:link></s:else></span></caption>
			<tr>
				<td>充值批次ID</td>
