...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
		function relogin(){
			var url = $(top.document.getElementById('logoutId')).attr('href');
			if(isEmpty(url)){
				url = 'index.do';
			}
			var urls = url.split('=');
			...
			url=CONTEXT_PATH + "/index.do?bno=" + bno;
		...
		<table width="100%" border="0" cellspacing="5" cellpadding="0">
		  ...
		  <tr>
		    <td height="60" colspan="4" align="left" valign="middle">
		    	您的登录已超时，请<a href="javascript:void(0);" onclick="relogin();">重新登录</a>！
		    </td>
		  </tr>
		  <tr>
		    <td height="30" colspan="4">
		      ...
		      <input style="margin-left:30px;" type="submit" value=" 返 回 " class="inp_L3" onmouseover="this.className='inp_L4'" onmouseout="this.className='inp_L3'" id="input_btn3"  name="escape" onclick="relogin();"/>    </td>
		    </tr>
		  </table>   
		</div>
		<b class="b4"></b>
