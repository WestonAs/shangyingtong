		...
		<table width="100%" border="0" cellspacing="5" cellpadding="0">
		  ...
		  <tr>
		    <td height="30" colspan="4">
		      ...
		      <input style="margin-left:30px;" type="submit" value=" 返 回 " class="inp_L3" onmouseover="this.className='inp_L4'" onmouseout="this.className='inp_L3'" id="input_btn3"  name="escape" onclick="window.history.go(-1);"/>    </td>
		    </tr>
		  </table>   
		</div>
		<b class="b4"></b>
