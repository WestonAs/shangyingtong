	...
	<body>
			...
			<div class="contentb">
				<s:form id="searchForm" action="list.do" cssClass="validate-tip" >
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>卡账户详细查询 | <span class="caption_title"><f:link href="/cardAcct/listDiscontinuousCard.do">批量不连号卡账户详细查询</f:link></span></caption>
						<tr>					
							...
							<td>
								...
								<s:hidden id="idBranchCode" name="acctInfo.cardIssuer"/>
								<s:textfield id="idBranchName" name="branchName" />
							</s:if>
							<s:else>
								<s:select id="idBranchCode" name="acctInfo.cardIssuer" list="cardBranchList" 
						...
						<tr>
							...
							<td>
							<s:select name="acctInfo.cardClass" list="cardTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name"></s:select>
							</td>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/cardAcct/detail.do?acctInfo.acctId=${acctId}&formMap.fromPage=list">账户明细</f:link>  		
			  		<f:link href="/cardAcct/acctTransList.do?formMap.cardId=${cardId}&formMap.fromPage=list">交易明细</f:link>  				  		
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<div class="userbox">
			...
			<div class="contentb">
				...
				<ul class="showli_div">
				<li class="showli_div">必须同时输入开始卡号和结束卡号查询。</li>
				<li class="showli_div">开始卡号和结束卡号相隔不能大于1000万。</li>
				</ul>
			</div>
			<b class="b4"></b><b class="b3"></b><b class="b2"></b><b class="b1"></b>
		</div>
