					...
					<div>
						<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
							...
							<tr id="id_branchCode_center_tr">
								...
								<td><s:textfield name="wsClientIpLimit.branchCode" cssClass="readonly {required:true}" readonly="true"/></td>
							...
							<tr style="margin-top: 30px;">
								...
								<td colspan="11"><s:textfield name="wsClientIpLimit.remark" maxlength="128"/></td>
							</tr>
							<tr>
								<td></td>
