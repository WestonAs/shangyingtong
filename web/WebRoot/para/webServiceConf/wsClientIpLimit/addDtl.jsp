...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="contentDiv" class="userbox">
			...
			<div class="contentb">
				<s:form action="addDtl.do" id="inputForm" cssClass="validate">
					<div>
						<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
							<caption>WS客户端ip限制-明细添加</caption>
							
							<tr id="id_branchCode_center_tr">
								<td width="80" height="30" align="right">机构编号</td>
								<td><s:textfield name="wsClientIpLimitDtl.branchCode" cssClass="{required:true}"/></td>
								
								<td width="80" height="30" align="right">IP</td>
								<td><s:textfield name="wsClientIpLimitDtl.ip" cssClass="{required:true}"/></td>
							</tr>
							...
							<tr style="margin-top: 30px">
								...
								<td colspan="11"><s:textfield name="wsClientIpLimitDtl.remark" size="128"/></td>
							</tr>
							<tr>
								<td></td>
