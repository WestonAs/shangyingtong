					...
					<div>
						<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
							...
							<tr id="id_branchCode_center_tr">
								...
								<td><s:textfield name="wsMsgTypeCtrl.branchCode" cssClass="{required:true}"/></td>
								
								<td width="80" height="30" align="right">接口类型编号</td>
								<td><s:textfield name="wsMsgTypeCtrl.msgType" cssClass="{required:true}"/></td>
							</tr>
							...
							<tr>
								...
								<td colspan="11"><s:textfield name="wsMsgTypeCtrl.remark" size="128"/></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
