				...
				<s:form action="modifyType.do" id="inputForm" cssClass="validate">
					<div>
						<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
							<caption>机构业务配置-类型修改</caption>
							
							<tr>
								<td width="80" height="30" align="right">配置类型编号</td>
								<td><s:textfield name="branchBizConfigType.configType" cssClass="readonly {required:true}" readonly="true"/></td>
								<td width="80" height="30" align="right">类型名称</td>
								<td><s:textfield name="branchBizConfigType.configTypeName" cssClass="{required:true}" maxlength="40"/></td>
							</tr>
							<tr style="margin-top: 30px;">
								<td width="80" height="30" align="right">备注</td>
								<td colspan="11"><s:textfield name="branchBizConfigType.remark" maxlength="128"/></td>
							</tr>
