	...
	<body>
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								...
								<f:pspan pid="logoConfig_add"><input style="margin-left:10px;" type="button" value="新增" onclick="javascript:gotoUrl('/para/cardPrevConfig/showAdd.do');" id="input_btn3"  name="escape" /></f:pspan>
							</td>
						</tr>
					</table>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">卡号前三位</td>
			...
			<tr>		
			  ...
			  <td align="center" nowrap>${cardPrev}</td>
			  <td align="center" nowrap>${statusName}</td>
			  <td align="center" nowrap>${updateBy}</td>
			  <td align="center" nowrap><s:date name="updateTime" format="yyyy-MM-dd HH:mm:ss" /></td>
			  <td align="center" nowrap>
			  	<span class="redlink">
				  	<f:pspan pid="cardPrevConfig_delete">
			  			<a href="javascript:submitUrl('searchForm', '/para/cardPrevConfig/delete.do?branchCode=${branchCode}', '确定要删除吗？');" />删除</a>
			  		</f:pspan>	
			  	</span>
			  </td>
			</tr>
