			...
			<div class="contentb">
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<td>
							<s:select id="id_issType" name="rmaFilePara.issType" list="issTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
						...
						<td id="id_merch_2" style="display: none">
							<s:hidden id="id_MerchId" name="rmaFilePara.issCode"
						...
						<tr>
							...
							<td height="30" colspan="3">
								...
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/para/rmaFilePara/list.do?goBack=goBack')" class="ml30" />
							</td>
						</tr>
					</table>
