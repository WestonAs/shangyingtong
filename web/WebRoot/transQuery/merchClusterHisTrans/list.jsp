...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
		$(function(){
			$('#generateExcelBtn').click(function(){generateExcel(false)});
	...
	<body>
			...
			<div class="contentb">
				<s:form id="searchForm" action="list.do" cssClass="validate-tip" >
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>${ACT.name} | <span class="caption_title"><f:link href="/transQuery/merchClusterHisTrans/listSummary.do">商户集群历史交易汇总查询</f:link></span></caption>
						<tr>
							...
							<td>
								<s:select id="merchClusterId" name="merchClusterId" 
									list="merchClusterInfos" listKey="merchClusterId" listValue="merchClusterName" 
									headerKey="" headerValue="--请选择--" cssClass="{required:true}" 
						...
						<tr>
							...
							<td align="right"><label for="generateExcelTableTitle">是否生成表头</label></td>
							<td>
								<s:checkbox id="generateExcelTableTitle" name="generateExcelTableTitle" fieldValue="true"/>
							</td>
						...
						<tr>
							...
							<td>
								<s:textfield id="startRcvTime" name="formMap.startRcvTime" onclick='WdatePicker({dateFmt:"yyyy-MM-dd HH:mm:ss", maxDate:"#F{$dp.$D(\'endRcvTime\')}" });'  cssStyle="width:128px;"/>&nbsp;-&nbsp;
								<s:textfield id="endRcvTime" name="formMap.endRcvTime" onclick='WdatePicker({dateFmt:"yyyy-MM-dd HH:mm:ss", minDate:"#F{$dp.$D(\'startRcvTime\')}" });'  cssStyle="width:128px;"/>
							</td>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">参考号</td>
			   <td align="center" nowrap class="titlebg">响应码</td>

			   <td align="center" nowrap class="titlebg">处理状态</td>
			   <td align="center" nowrap class="titlebg">原流水号</td>
			   <td align="center" nowrap class="titlebg">附加信息</td>
			   <td align="center" nowrap class="titlebg">卡BIN</td>
			</tr>
			</thead>
			<s:iterator value="page.data"> 
				<tr>
				  <td align="left" nowrap>${merNo}</td>
				  <td align="left" nowrap>${fn:merch(merNo)}</td>
				  ...
				  <td align="center" nowrap><s:property value='posSn.substring(10,16)'/></td>
				  <td align="center" nowrap>${retrivlRefNum}</td>
				  <td align="center" nowrap>${respCode}</td>

				  <td align="center" nowrap>${procStatusName}</td>	
				  <td align="center" nowrap></td>
				  <td align="center" nowrap>${reserved2}</td>
		...
		<div class="userbox">
			...
			<div class="contentb">
				...
				<li class="showli_div">本页面只查询处理状态为“扣款成功”的历史记录。</li>
				</ul>
			</div>
			<b class="b4"></b><b class="b3"></b><b class="b2"></b><b class="b1"></b>
		</div>
