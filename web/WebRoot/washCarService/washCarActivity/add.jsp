		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="add.do" id="inputForm" cssClass="validate">
						...
						<tr>
							...
							<s:if test="merchantRoleLogined">
								...
								<td>
								    ...
								    <s:textfield name="merchName" cssClass="{required:true} readonly" readonly="true"/>
								</td>
							</s:if>
							<s:else>
								<td align="right">商户</td>
								<td>
								    ...
								    <s:textfield id="idMerchId_sel" name="merchName" cssClass="{required:true}"/>
					...
					<s:token name="_TOKEN_WHSHCARACTIVITY_ADD"/>
					</div>
				</s:form>
			</div>
