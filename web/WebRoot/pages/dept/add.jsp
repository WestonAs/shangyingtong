...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			$loadTree('/pages/role/initTreeByAddDept.do', 'treebox_tree', true);
			//Selector.selectBranch('idBranchCode_sel', 'idBranchCode', true, '00,20');
		});
		function checkTree(){
			...
			<div class="contentb">
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td width="80" height="30" align="right">部门名称</td>
							<td>
						...
						<tr>
							<td width="80" height="30" align="right" valign="top" style="padding-top: 10px">部门拥有权限</td>
							<td>
