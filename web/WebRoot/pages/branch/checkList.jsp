...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 数据列表区 -->
		<div class="tablebox">
			<form id="id_check_branch" method="post" action="checkList.do">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${branchCode}"/></td>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
		  			<f:link href="/pages/branch/checkDetail.do?branch.branchCode=${branchCode}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="branchAdapter" returnUrl="/pages/branch/checkList.do"><s:token name="_TOKEN_BRANCH_CHECKLIST"/></f:workflow>
		</div>
