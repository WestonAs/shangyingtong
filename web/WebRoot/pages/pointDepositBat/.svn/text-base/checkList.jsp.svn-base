...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/pages/pointDepositBat/checkDetail.do?depositPointReg.depositBatchId=${depositBatchId}">明细</f:link>
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<f:workflow adapter="depositPointAdapter" returnUrl="/pages/pointDepositBat/checkList.do"><s:token/></f:workflow>
		</div>
