			...
			<div class="contentb">
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>${ACT.name}<span class="caption_title"> | <f:link href="/pages/role/showAddCommon.do">我要创建某类通用角色?</f:link></span></caption>
						<tr>
					...
					<s:token name="_TOKEN_ROLE_MODIFY_COMMON"/>
