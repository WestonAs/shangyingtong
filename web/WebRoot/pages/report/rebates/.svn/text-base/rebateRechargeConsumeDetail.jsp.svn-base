...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="rebateRechargeConsumeDetail.do" cssClass="validate-tip">
					<table id="searchForm" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption><span class="caption_title"><f:link href="/pages/report/rebates/rebateRechargeConsumeGather.do">
						返利账户充值消费统计汇总报表 |
						</f:link></span>
						 返利账户充值消费统计明细报表
						</caption>
		...
		<div class="clear">
			<s:if test="formMap.reportParamsString != null">
				<report:html name="report1" reportFileName="/rebates/rebateRechargeConsumeDetail.raq"	
				    params="${formMap.reportParamsString}"
					reportEnterUrl="/pages/report/rebates/rebateRechargeConsumeDetail.do" 
				    funcBarFontFace="宋体"               
