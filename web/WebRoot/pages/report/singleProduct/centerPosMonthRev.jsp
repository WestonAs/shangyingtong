...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
	 	ICardReportLoad operateFee = (ICardReportLoad)SpringContext.getService("singleProductCenterPOSMonthRev");
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<form id="searchForm" method="post" action="centerPosMonthRev.jsp" class="validate-tip">
		...
		<%
			...
			if(StringUtils.isNotBlank(feeMonth)){
				params.append("feeDate=" + feeMonth + ";");
