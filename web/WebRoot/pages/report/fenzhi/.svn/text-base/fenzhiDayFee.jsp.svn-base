...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
	 	ICardReportLoad operateFee = (ICardReportLoad)SpringContext.getService("fenzhiSellDepositFeeDayImpl");
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<form id="searchForm" method="post" action="fenzhiDayFee.jsp" class="validate-tip">
		...
		<%
			...
			// 计费日期
			String setDate = request.getParameter("feeMonth");
