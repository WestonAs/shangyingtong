	...
	<head>
		...
		<script>
			function downLoadReportFile(reportType, merchantNo, reportDate){
		      location.href = CONTEXT_PATH + "/pages/report/fenzhi/dayReportDownload.do?reportPathSave.reportType="
				...
				<s:form action="dayList.do" cssClass="validate-tip">
					<table id="searchForm" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select  name="reportPathSave.merchantNo" headerKey="" headerValue="--请选择--" list="fenzhiList" 
					...
					<s:token name="_TOKEN_REPORT_FENZHI_DAY_LIST"/>
				</s:form>
			</div>
