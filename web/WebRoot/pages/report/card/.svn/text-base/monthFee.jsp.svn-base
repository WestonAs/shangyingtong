...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<form id="searchForm" method="post" action="monthFee.jsp" class="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>${ACT.name}</caption>
						<tr>
							<td align="right">统计月份</td>
							<td>
								<input type="text" id="id_setDate" name="setDate" onclick="WdatePicker({dateFmt:'yyyyMM'})" class="{required:true}" value="${param.setDate}" />
							</td>
		...
		<div class="clear">
			...
			<% if(StringUtils.isNotBlank(params.toString())){ %>
				<report:html name="report1" reportFileName="/card/sellDepositFeeMSet.raq"	
