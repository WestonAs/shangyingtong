...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="terminalTransDaySum.do" cssClass="validate-tip">
						...
						<tr>
							<s:if test="centerOrCenterDeptRoleLogined || fenzhiRoleLogined">
								...
								<td>
									...
									<input type="text" id="idBranchCode_sel" name="formMap.cardBranchName" value="${fn:branch(formMap.cardBranchCode) }" class="{required: true}" />
								</td>
							</s:if>
							<s:elseif test="cardOrCardDeptRoleLogined">
								<td align="right">发卡机构</td>
								<td>
									<s:select name="formMap.cardBranchCode" list="cardBranchList" listKey="branchCode" listValue="branchName" 
		...
		<div class="clear">
			<s:if test="formMap.reportParamsString != ''">
				<report:html name="report1" reportFileName="/card/terminalTransDaySum.raq"	
				    params="${formMap.reportParamsString}"
					reportEnterUrl="pages/report/card/terminalTransDaySum.do" 
				    funcBarFontFace="宋体"               
		...
		<div class="userbox">
			...
			<div class="contentb">
				...
				<ul class="showli_div">
					<li class="showli_div">本报表只统计“扣款成功”状态的记录。</li>
					<li class="showli_div">本报表只统计消费类型的记录，比如：正常消费、部分消费、次卡消费、过期消费、现金暗折消费、扣减积分、积分消费、预授权完成、电子现金消费。</li>
				</ul> 
			</div>
			<b class="b4"></b><b class="b3"></b><b class="b2"></b><b class="b1"></b>
		</div>
