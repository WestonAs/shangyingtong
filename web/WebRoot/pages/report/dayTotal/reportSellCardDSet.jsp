...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
	 	ICardReportLoad operateFee = (ICardReportLoad)SpringContext.getService("cardProxySellDepositReport");
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<form id="searchForm" method="post" action="reportSellCardDSet.jsp" class="validate-tip">
						...
						<tr>
							...
							<td id="id_payCode_td2">
								...
								<c:forEach items="${recvCodeList}" var="t">
									<option value="${t.branchCode}" <c:if test="${param.recvCode eq t.branchCode}">selected</c:if>><c:out value="${t.branchName }"/></option>	
								</c:forEach>
								</select>
							</td>
							</c:if>
