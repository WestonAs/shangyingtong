...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
	 	ICardReportLoad operateFee = (ICardReportLoad)SpringContext.getService("reportCZCMCCPointConsume");
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<form id="searchForm" method="post" action="pointConsume.jsp" class="validate-tip">
		...
		<report:html name="report1" reportFileName="${reportFile}"	
			...
			pageMarkLabel="当前{currPage}页,共{totalPage}页"
