...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script>
			...
			function downLoadReportFile(merchantNo, reportDate) {
				location.href = CONTEXT_PATH
						+ "/pages/report/consmChargeBalReportDownload.do?formMap.merchantNo="
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="consmChargeBalReportList.do" cssClass="validate-tip">
					...
					<s:token name="_TOKEN_CONSM_CHARGE_BAL_REPORT_LIST"/>
				</s:form>
			</div>
