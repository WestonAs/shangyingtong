...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>赠券赠送明细信息<span class="caption_title"> | <f:link href="/pages/couponDeposit/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>赠送批次ID</td>
			...
			<tr>
		  		<td>赠送赠券</td>
				<td>${depositCouponReg.couponAmt}</td>
				<td>折算金额</td>
				<td>${fn:amount(depositCouponReg.refAmt)}</td>
				<td>赠券类型</td>
				<td>${depositCouponReg.couponClass}</td>
			</tr>
			<tr>
				<td>赠送机构号</td>
