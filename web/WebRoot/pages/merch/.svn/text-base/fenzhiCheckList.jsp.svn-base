...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 数据列表区 -->
		<div class="tablebox">
			<form id="id_check_merch" method="post" action="fenzhiCheckList.do">
		...
		<f:workflow adapter="merchCardAdapter" returnUrl="/pages/merch/fenzhiCheckList.do"><s:token name="_TOKEN_MERCH_FENZHI_CHECKLIST"/></f:workflow>
		</div>
		...
		<div class="userbox" style="padding-top: 10px">
			...
			<div class="contentb">
				...
				<ul class="showli_div">
					<li class="showli_div">本审核页面用于 分支机构 审核 发卡机构或部门添加的商户。</li>
				</ul> 
			</div>
