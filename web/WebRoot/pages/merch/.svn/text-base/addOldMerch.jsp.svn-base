...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function clearCarBinError(){
			$('#idmerchAdmin_field').removeClass('error_tipinfo').html('用户名为数字字符');
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="addOldMerch.do" id="inputForm" cssClass="validate">
					<div>
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield id="id_merchAdmin" name="merchAdmin" cssClass="{required:true, digitOrLetter:true}" />
								<span id="idmerchAdmin_field" class="field_tipinfo">请输入数字字符</span>
							</td>
						</tr>
					...
					<s:token name="_TOKEN_MERCH_ADDOLDMERCH"/>
				</s:form>
			</div>
