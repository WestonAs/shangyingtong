...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
		$(function(){
			Selector.selectMerch('idMerchNames', 'idMerchs', false, '${branchNo}');
		});
		</script>
	</head>
				...
				<s:form action="modify.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:hidden name="cardMerchGroup.branchCode"/>
								<s:hidden name="cardMerchGroup.groupId"/>
						...
						<tr>
							...
							<td>
								...
								<span class="field_tipinfo">请输入商圈类型</span>
							</td>
						</tr>
					...
					<s:token name="_TOKEN_CARD_MERCH_GROUP_MODIFY"/>
				</s:form>
			</div>
