	...
	<body>
				...
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="form_grid" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield name="cardExampleDef.cardExampleId"/>
							</td>
							<td align="right">卡样名称</td>
							<td>
								<s:textfield name="cardExampleDef.cardExampleName" />
							</td>
							<td align="right">状态</td>
							<td>
								<s:select name="cardExampleDef.status" list="statusList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" ></s:select>
							</td>
						</tr>
						<tr>
							...
							<td height="30" colspan="4">
								...
								<f:pspan pid="single_product_style_add">
									<input style="margin-left:10px;" type="button" value="新增" onclick="javascript:gotoUrl('/pages/singleProduct/style/showAdd.do');" id="input_btn3"  name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">明细</td>
			</tr>
			</thead>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/pages/singleProduct/style/detail.do?cardExampleDef.cardExampleId=${cardExampleId}">明细</f:link>
			  		<!-- 
			  		<f:link href="/pages/singleProduct/style/showDownload.do?cardStyleId=${cardStyleId}">下载</f:link>
			  		 -->
			  	</span>
			  </td>
			</tr>
