...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="contentDiv" class="userbox">
			...
			<div class="contentb">
				<s:form action="addBatch.do" id="inputForm" cssClass="validate">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>批量添加终端</caption>
						...
						<tr>	
							...
							<td width="80" height="30" align="right">终端数量</td>
							<td>
								<s:textfield id="idTerminalCount" name="terminalCount" cssClass="{required:true, digit:true}" maxlength="5"/>
					...
					<s:token name="_TOKEN_TERMINAL_ADD_BATCH"/>
				</s:form>
			</div>
