	...
	<body>
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td height="30" colspan="5">
								...
								<f:pspan pid="point_deposit_add">
									<input style="margin-left:30px;" type="button" value="新增" onclick="javascript:gotoUrl('/pages/pointDeposit/showAdd.do');" id="input_btn3"  name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_POINT_DEPOSIT_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>	
			  ...
			  <td align="right" nowrap>${ptPoint}</td>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/pages/pointDeposit/detail.do?depositPointReg.depositBatchId=${depositBatchId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
