			...
			<div class="contentb">
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td align="right">赠送批次</td>
							<td>
								<s:textfield name="depositCouponReg.depositBatchId" cssClass="{digit:true}"/>
							</td>							
							<td align="right">卡号</td>
							<td>
								<s:textfield name="depositCouponReg.cardId" cssClass="{digit:true}"/>
							</td>							
							<td align="right">状态</td>
							<td>
								<s:select name="depositCouponReg.status" list="statusList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name"></s:select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:if test="showCardBranch">
									<s:hidden id="id_branchCode" name="depositCouponReg.cardBranch"/>
									<s:textfield id="id_branchCodeName" name="cardBranchName"/>
								</s:if>
								<s:else>
									<s:select name="depositCouponReg.cardBranch" list="cardBranchList" headerKey="" headerValue="--请选择--" listKey="branchCode" listValue="branchName" />
								</s:else>
							</td>
							<td align="right">赠券类型</td>
							<td>
								<s:textfield name="depositCouponReg.couponClass"/>
							</td>
						</tr>
						<tr>
							<td></td>
							<td height="30" colspan="5">
								...
								<f:pspan pid="coupon_deposit_bat_add">
									<input style="margin-left:30px;" type="button" value="新增" onclick="javascript:gotoUrl('/pages/couponDepositBat/showAdd.do');" id="input_btn1"  name="escape" />
<!-- 									<input style="margin-left:30px;" type="button" value="文件方式赠送" onclick="javascript:gotoUrl('/pages/couponDepositBat/showAddFile.do');" id="input_btn3"  name="escape" /> -->
								</f:pspan>
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_COUPON_DEPOSIT_BAT_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">赠送日期</td>
			...
			<tr>	
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/pages/couponDepositBat/detail.do?depositCouponReg.depositBatchId=${depositBatchId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
