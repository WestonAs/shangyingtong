...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>赠券赠送明细信息<span class="caption_title"> | <f:link href="/pages/couponDepositBat/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>赠送批次ID</td>
			...
			<tr>
		  	...
		  	<tr>
		  		<td>是否是文件方式</td>
				<td>${depositCouponReg.fileDepositName}</td>
		  		<td>更新人</td>
				<td>${depositCouponReg.updateUser}</td>
		  		<td>更新时间</td>
				<td><s:date name="depositCouponReg.updateTime" format="yyyy-MM-dd HH:mm:ss" /></td>
		  	</tr>
		  	<tr>
				<td>备注</td>
