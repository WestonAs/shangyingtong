	...
	<body>
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip" onsubmit="return clearText();">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td><s:textfield id="clusterId_id" name="clusterInfo.clustername"  cssStyle="font-size:12px;" /></td>
							<!--
						...
						<tr>
							...
							<td height="30" colspan="5">
								...
								<f:pspan pid="cardclustermgr_cluster_add">
									<input class="ml30" type="button" value="新增" onclick="javascript:gotoUrl('/pages/cardCluster/showAddCluster.do');" id="input_btn3" name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>${clustername}</td>
			  ...
			  <td align="center" nowrap>
			  	 <span class="redlink">
			  		<f:link href="/pages/cardCluster/detail.do?clusterInfo.clusterid=${clusterid}">明细</f:link>
				     <f:pspan pid="cardclustermgr_cluster_delete" >
			  			<a href="javascript:submitUrl('searchForm', '/pages/cardCluster/deleteCluster.do?clusterInfo.clusterid=${clusterid}&clusterName=${clustername}', '确定要删除吗？');" />删除</a>
			  		 </f:pspan>
			     </span>
			  </td>
			</tr>
