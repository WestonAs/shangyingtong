...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<f:js src="/js/biz/icEcashDeposit/add.js"/>
				...
				<s:form action="add.do" id="inputForm" cssClass="validate">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td id="id_touchType">请将卡放入读卡器：
								<input type="button" value="查询卡余额" id="input_btn2"  name="ok"  onclick="IcEcashDeposit.readCardInfo();"/>
							</td>
						</tr>
					</table>
					<table id="idDepositTbl" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0" >
						<tr>
							...
							<td>
								<s:textfield id="id_cardId" name="icEcashDepositReg.cardId" readonly="true" cssClass="{required:true} readonly"/>
							</td>
							<td width="80" height="30" align="right">卡种类</td>
							<td>
								<s:hidden id="id_cardClass" name="icEcashDepositReg.cardClass" />
						...
						<tr>
							...
							<td>
								<s:textfield id="id_cardSubClass" name="icEcashDepositReg.cardSubClass" readonly="true" cssClass="{required:true} readonly"/>
							</td>
							...
							<td>
								<s:textfield id="id_cardBranch" name="icEcashDepositReg.cardBranch" readonly="true" cssClass="{required:true} readonly"/>
							</td>							
						</tr>
						<tr>
							<td width="80" height="30" align="right">余额</td>
							<td>
								<s:textfield id="id_lastBalance" name="icEcashDepositReg.lastBalance" readonly="true" cssClass="{required:true} readonly bigred"/>
							</td>							
							<td width="80" height="30" align="right">卡余额上限</td>
							<td>
								<s:textfield id="id_balanceLimit" name="icEcashDepositReg.balanceLimit" readonly="true" cssClass="{required:true} readonly bigred"/>
							</td>							
						...
						<tr>
							<td width="80" height="30" align="right">充值金额</td>
							<td>
								<s:textfield id="id_depositAmt" name="icEcashDepositReg.depositAmt" 
									cssClass="{required:true, num:true} bigred" maxlength="13" onchange="calRealAmt();"/>
								<span class="field_tipinfo">请输入整数或小数金额</span>
							</td>
							<td width="80" height="30" align="right">备注</td>
							<td colspan="3">
								<s:textfield id="id_remark" name="icEcashDepositReg.remark" />
							</td>
						</tr>
					</table>
					...
					<table id="rebateTable" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0" style="display: none;">
						<tr>
							<td width="90px" height="30" align="right">
								返利总金额
								<span id="periodLabel" class="no">(分期)</span>
							</td>
							<td colspan="11">
								<s:textfield id="rebateAmt" name="icEcashDepositReg.rebateAmt" cssClass="{required:true} readonly" readonly="true" />
								&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<tr>
							...
							<s:hidden id="id_cardSn" name="icEcashDepositReg.cardSn"/>
							<s:hidden id="id_serialNo" name="serialNo"/>
							<s:hidden id="id_ARQC" name="icEcashDepositReg.arqc"/>
							<s:hidden id="id_AQDT" name="icEcashDepositReg.aqdt"/>

							<s:hidden id="rebateId" name="icEcashDepositReg.rebateId"  />	

							<s:hidden id="id_randomSessionId" name="icEcashDepositReg.randomSessionid" />
							<s:hidden id="id_signature" name="icEcashDepositReg.signature" />
						...
						<tr>
							...
							<td height="30" colspan="3">
								<input type="button" value="充值" id="depositBtn"  name="ok"  onclick="return IcEcashDeposit.checkForm();"/>
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/pages/icEcashDeposit/list.do?goBack=goBack')" class="ml30" />
							</td>
							<td></td><td></td>
						</tr>
					</table>
