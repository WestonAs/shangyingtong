...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			   <td align="center" nowrap class="titlebg">
			   		<label> <input type="checkbox" onclick="FormUtils.selectAll(this, 'ids')" />全选 </label>
			   </td>
			...
			<tr>
			  ...
			  <td align="center" nowrap>
				  	<span class="redlink">
					  	...
					  	&nbsp;
				  		<f:link href="/pages/externalCardImport/detail.do?externalCardImportReg.id=${id}&formMap.useReferer=true">查看</f:link>
				  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="externalNumMakeCardAdapter" returnUrl="/pages/externalCardImport/checkListExternalNumMakeCard.do">
			<s:token name="_TOKEN_CANCELCARD_CHECKLIST"/>
		</f:workflow>
