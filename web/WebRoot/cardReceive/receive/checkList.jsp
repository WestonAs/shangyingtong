...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
		  			<f:link href="/cardReceive/receive/showCheck.do?appReg.id=${id}">审核处理</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="cardReceiveAdapter" returnUrl="/cardReceive/receive/checkList.do"><s:token name="_TOKEN_CARDREACIVE_CHECKLIST"/></f:workflow>
		</div>
