		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="modify.do" id="inputForm" cssClass="validate">
					<s:hidden name="accountSystemInfo.systemId"></s:hidden>
					<s:hidden name="accountSystemInfo.custId"></s:hidden>
					<s:hidden name="accountSystemInfo.parentBranch"></s:hidden>
					<s:hidden name="accountSystemInfo.createTime"></s:hidden>
					<div>
						<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
							...
							<tr>
								...
								<td>
									<s:textfield id="custName" name="accountSystemInfo.custName" cssClass="{required:true}" maxlength="19" readonly="true"/>
