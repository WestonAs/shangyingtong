				...
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield name="signRuleReg.signRuleName" cssClass="{required:true}"/>
						...
						<tr>
							...
							<td id="derateCountId_td2" style="display: none;">
								<s:textfield id="derateCountId" name="signRuleReg.derateCount" cssClass="{required:true, digit:true, min:1}" disabled="true"/>
							...
							<td id="derateAmtId_td2" style="display: none;">
								<s:textfield id="derateAmtId" name="signRuleReg.derateAmt" cssClass="{required:true, num:true}" disabled="true"/>
					...
					<s:token name="_TOKEN_SIGN_RULE_REG_ADD"/>
				</s:form>
			</div>
