...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			...
			Selector.selectMerch('merchName', 'id_merchId', true, branchCode);
		});
			...
			<div class="contentb">
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<tr>
						...
						<td> 
							<s:hidden id="id_merchId" name="cardMerchRemitAccount.merchId" />
					...
					<tr style="margin-top: 30px;">
						...
						<input type="button" value="返回" name="escape" onclick="gotoUrl('/cardMerchRemitAcc/list.do?goBack=goBack')" class="ml30" />
						</td>
					</tr>
					</table>
					<s:token name="_TOKEN_CARDMERCHREMITACC_ADD"/>
				</s:form>
			</div>
