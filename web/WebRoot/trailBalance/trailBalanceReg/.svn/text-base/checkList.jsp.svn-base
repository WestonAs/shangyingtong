	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>${classId}-${className}</td>
			  <td align="center" nowrap>${statusName}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/trailBalance/trailBalanceReg/checkDetail.do?trailBalanceReg.id=${id}">明细</f:link>
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<f:workflow adapter="trailBalanceAdapter" returnUrl="/trailBalance/trailBalanceReg/checkList.do"><s:token name="_TOKEN_TRAILBALANCEREG_CHECKLIST"/></f:workflow>
		</div>
