	...
	<body>
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<s:if test="showCard">
							<td><s:select name="trailBalanceAccu.cardIssuer" headerKey="" headerValue="--请选择--" list="branchList" listKey="branchCode" listValue="branchName"></s:select>
							</td>
							</s:if>
							<s:else>
							<td><s:textfield name="trailBalanceAccu.cardIssuer"/></td>	
							</s:else>
							
							<td align="right">平衡类型</td>
							<td>
							<s:select name="trailBalanceAccu.balanceFlag" list="balanceFlagList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name"></s:select>
							</td>
							<td align="right">试算日期</td>
							<td><s:textfield name="trailBalanceAccu.settDate" onclick="WdatePicker()"/></td>	
						</tr>
						<tr>
							<td></td>
					...
					<s:token name="_TOKEN_TRAILBALANCEACCU_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>	
			  ...
			  <td align="center" nowrap>${accuClass}-${className}</td>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/trailBalance/trailBalanceAccuQuery/detail.do?trailBalanceAccu.settDate=${settDate}&trailBalanceAccu.accuClass=${accuClass}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
