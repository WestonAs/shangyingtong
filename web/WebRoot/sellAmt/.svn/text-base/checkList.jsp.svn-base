...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/sellAmt/checkDetail.do?branchSellReg.id=${id}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="branchSellAdapter" returnUrl="/sellAmt/checkList.do"><s:token name="_TOKEN_SELL_AMT_CHECK"/></f:workflow>
		</div>
