...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form id="searchForm" action="listPreDepositCancel.do" cssClass="validate-tip">
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/saleCardBatReg/detailPreDepositCancel.do?saleCardBatReg.saleBatchId=${saleBatchId}">查看</f:link>			  		
			  	</span>
			  	<f:pspan pid="saleCardPre_cancel">
			  		<a href="javascript:submitUrl('searchForm', '/saleCardBatReg/preDepositCancel.do?saleCardBatReg.saleBatchId=${saleBatchId}', '确定要撤销吗？');" />撤销</a>
			  	</f:pspan>
			  </td>
			</tr>
			</s:iterator>
