	...
	<body>
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<s:select name="releaseCardFeeDTotal.chlCode" headerKey="" headerValue="--请选择--" list="chlList" listKey="branchCode" listValue="branchName"></s:select>
							</s:if>
							<s:else>
							<s:textfield name="releaseCardFeeDTotal.chlName"></s:textfield>
							</s:else>
							</td>
					...
					<s:token name="_TOKEN_BRANCHSHARESINFO_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">分支机构分润金额</td>
			...
			<tr>		
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/releaseCardFee/branchSharesInfo/detail.do?releaseCardFeeDTotal.feeDate=${feeDate}&releaseCardFeeDTotal.branchCode=${branchCode}&releaseCardFeeDTotal.merchId=${merchId}&releaseCardFeeDTotal.cardBin=${cardBin}&releaseCardFeeDTotal.transType=${transType}&releaseCardFeeDTotal.posManageId=${posManageId}&releaseCardFeeDTotal.posProvId=${posProvId}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
