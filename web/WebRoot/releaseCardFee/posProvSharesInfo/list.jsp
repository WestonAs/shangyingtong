	...
	<body>
			...
			<div class="contentb">
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td align="right">出机方</td>
							<td>
							<s:if test="showTerminal">
							<s:select name="releaseCardFeeDTotal.posProvId" headerKey="" headerValue="--请选择--" list="posProvList" listKey="branchCode" listValue="branchName"></s:select>
							</s:if>
							<s:else>
							<s:textfield name="releaseCardFeeDTotal.posProvName"></s:textfield>
							</s:else>
							</td>
					...
					<s:token name="_TOKEN_POSPROVSHARESINFO_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">出机方分润金额</td>
			...
			<tr>		
			  ...
			  <td align="right" nowrap>${fn:amount(provFeeAmt)}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/releaseCardFee/posProvSharesInfo/detail.do?releaseCardFeeDTotal.feeDate=${feeDate}&releaseCardFeeDTotal.branchCode=${branchCode}&releaseCardFeeDTotal.merchId=${merchId}&releaseCardFeeDTotal.cardBin=${cardBin}&releaseCardFeeDTotal.transType=${transType}&releaseCardFeeDTotal.posManageId=${posManageId}&releaseCardFeeDTotal.posProvId=${posProvId}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
