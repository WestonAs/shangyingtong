	...
	<body>
			...
			<div class="contentb">
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td align="right">维护方</td>
							<td>
							<s:if test="showTerminalMaintain">
							<s:select name="releaseCardFeeDTotal.posManageId" headerKey="" headerValue="--请选择--" list="posManagevList" listKey="branchCode" listValue="branchName"></s:select>
							</s:if>
							<s:else>
							<s:textfield name="releaseCardFeeDTotal.posManageName"></s:textfield>
							</s:else>
							</td>
					...
					<s:token name="_TOKEN_POSMANAGESHARESINFO_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">维护方</td>
			   ...
			   <td align="center" nowrap class="titlebg">维护方分润金额</td>
			...
			<tr>		
			  ...
			  <td align="right" nowrap>${fn:amount(manageFeeAmt)}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/releaseCardFee/posManageSharesInfo/detail.do?releaseCardFeeDTotal.feeDate=${feeDate}&releaseCardFeeDTotal.branchCode=${branchCode}&releaseCardFeeDTotal.merchId=${merchId}&releaseCardFeeDTotal.cardBin=${cardBin}&releaseCardFeeDTotal.transType=${transType}&releaseCardFeeDTotal.posManageId=${posManageId}&releaseCardFeeDTotal.posProvId=${posProvId}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
