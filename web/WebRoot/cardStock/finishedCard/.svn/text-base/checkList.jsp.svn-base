...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
		  			<f:link href="/cardStock/finishedCard/checkDetail.do?cardInput.id=${id}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="finishedCardStockAdapter" returnUrl="/cardStock/finishedCard/checkList.do"><s:token name="_TOKEN_FINISHEDINPUT_CHECKLIST"/></f:workflow>
		</div>
