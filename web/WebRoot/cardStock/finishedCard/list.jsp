	...
	<body>
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select name="cardInput.cardType" list="cardTypeList" headerKey="" headerValue="--请选择--" listKey="cardTypeCode" listValue="cardTypeName">
								</s:select>
							</td>
							
							<td align="right">状态</td>
							<td>
								<s:select name="cardInput.status" list="statusList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name">
								</s:select>
							</td>
						</tr>
						...
						<tr>
							...
							<td height="30" colspan="4">
								...
								<f:pspan pid="finishedcard_add"><input style="margin-left:10px;" type="button" value="新增" onclick="javascript:gotoUrl('/cardStock/finishedCard/showAdd.do');" id="input_btn3"  name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_FINISHEDINPUT_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>${endNo}</td>
			  <td align="center" nowrap>${statusName}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/cardStock/finishedCard/detail.do?cardInput.id=${id}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
