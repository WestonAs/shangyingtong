				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:select name="whiteCardInput.cardType" list="cardTypeList" headerKey="" headerValue="--请选择--" listKey="cardTypeCode" listValue="cardTypeName">
								</s:select>
							</td>
							
							<td align="right">状态</td>
							<td>
								<s:select name="whiteCardInput.status" list="statusList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name">
								</s:select>
							</td>
						</tr>
						...
						<tr>
							...
							<td height="30" colspan="4">
								...
								<f:pspan pid="whitecardmgr_add"><input style="margin-left:10px;" type="button" value="新增" onclick="javascript:gotoUrl('/cardStock/whiteCard/showAdd.do');" id="input_btn3"  name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/cardStock/whiteCard/detail.do?whiteCardInput.id=${id}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
