...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="ruleModify.do" id="inputForm" cssClass="validate">
					...
					<!-- 
					 ...
					 -->
							...
							<td>
								...
								<s:hidden name="promtRuleDef.promtRuleId" />
								<s:select name="promtRuleDef.birthdayFlag" list="birthdayFlagList" headerKey="" headerValue="--请选择--" 
						...
						<tr id="subClassId_td3" style="display: none;">
							...
							<td id="subClassId_td2" style="display: none;">
								...
								<span class="field_tipinfo">请输入积分/赠券类型</span>
							</td>
						</tr>
						...
						<tr>
							...
							<td height="30" colspan="1">
								...
								<input type="button" value="返回上级" name="escape" onclick="gotoUrl('/promotions/promtDef/ruleList.do?promtRuleDef.promtId=${promtRuleDef.promtId}')" class="ml30" />
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_PROMT_DEF_RULEMODIFY"/>
				</s:form>
