		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form id="inputForm" method="post" cssClass="validate">
					...
					<!-- 
					 ...
					 -->
						...
						<tr>
							...
							<td>
								<s:textfield name="promtRuleDef.amtRef" cssClass="{required:true, num:true, decimal:'12,2'}" maxlength="15"/>
						...
						<tr id="rateId_td3" style="display: none;">
							<td id="rateId_td1" width="80" height="30" align="right" style="display: none;">倍率参数/持卡人折扣</td>
							<td id="rateId_td2" style="display: none;">
								<s:textfield id="rateId" name="promtRuleDef.ruleParam3" cssClass="{required:true, num:true, decimal:'6,2'}" maxlength="10" disabled="true"/>
								<span class="field_tipinfo">请输入倍率参数/持卡人折扣</span>
						...
						<tr id="amountId1_td3" style="display: none;">
							...
							<td id="amountId1_td2" style="display: none;">
								<s:textfield id="amountId1" name="promtRuleDef.ruleParam1" cssClass="{required:true, num:true, decimal:'12,2'}" maxlength="15" disabled="true"/>
						...
						<tr id="amountId2_td3" style="display: none;">
							...
							<td id="amountId2_td2" style="display: none;">
								<s:textfield id="amountId2" name="promtRuleDef.ruleParam2" cssClass="{required:true, num:true, decimal:'12,2'}" maxlength="15" disabled="true"/>
						...
						<tr id="pointId_td3" style="display: none;">
							...
							<td id="pointId_td2" style="display: none;">
								<s:textfield id="pointId" name="promtRuleDef.ruleParam4" cssClass="{required:true, num:true, decimal:'12,2'}" maxlength="14" disabled="true"/>
						...
						<tr id="subClassId_td3" style="display: none;">
							...
							<td id="subClassId_td2" style="display: none;">
								...
								<span id="sucClass_fieldId" class="field_tipinfo">积分/赠券类型</span>
							</td>
						</tr>
					...
					<s:token name="_TOKEN_PROMT_DEF_NEXTSTEP"/>
				</s:form>
