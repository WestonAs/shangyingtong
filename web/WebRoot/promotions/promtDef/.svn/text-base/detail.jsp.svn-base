...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>促销活动详细信息<span class="caption_title"> | <f:link href="/promotions/promtDef/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>促销活动ID</td>
		...
		<div class="tablebox">
			<b><s:label>促销活动范围详细信息</s:label></b>
		...
		<!-- 促销活动规则表 -->
		<div class="tablebox">
			<b><s:label>促销活动规则详细信息</s:label></b>
			<table class="" width="100%" border="0" cellspacing="0" cellpadding="0">
			<thead>
			<tr>
