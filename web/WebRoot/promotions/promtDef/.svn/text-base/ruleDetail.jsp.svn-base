...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>促销规则详细信息<span class="caption_title"> | <f:link href="/promotions/promtDef/ruleList.do?promtRuleDef.promtId=${promtRuleDef.promtId}&goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>促销规则ID</td>
