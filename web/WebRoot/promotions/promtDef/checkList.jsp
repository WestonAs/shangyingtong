...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/promotions/promtDef/checkDetail.do?promtDef.promtId=${promtId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="promotionsAdapter" returnUrl="/promotions/promtDef/checkList.do"><s:token name="_TOKEN_PROMT_DEF_CHECKLIST"/></f:workflow>
		</div>
