			...
			<div class="contentb">
				<s:form action="nextStep.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td width="80" height="30" align="right">协议活动名</td>
							<td>
					...
					<table class="form_grid" width="60%" border="0" cellspacing="3" cellpadding="0">
						<tr style="margin-top: 30px;">
							...
							<td height="30" colspan="3">
								...
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/promotions/protocolDef/list.do?goBack=goBack')" class="ml30" />
							</td>
						</tr>
					</table>
					<s:hidden />
					<s:token name="_TOKEN_PROTOCOL_DEF_ADD"/>
				</s:form>
