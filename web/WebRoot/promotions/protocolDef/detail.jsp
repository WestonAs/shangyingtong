...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>协议积分活动详细信息<span class="caption_title"> | <f:link href="/promotions/protocolDef/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>ID</td>
		...
		<!-- 促销活动范围 -->
		<s:if test="promtScopeList.size() > 0">
		<div class="tablebox">
		...
		<!-- 促销活动规则表 -->
		<s:if test="promtRuleList.size() > 0">
		<div class="tablebox">
			<table class="" width="100%" border="0" cellspacing="0" cellpadding="0">
			<thead>
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">规则类型</td>			   
			   <td align="center" nowrap class="titlebg">操作</td>			   
			</tr>
			</thead>
		...
		<jsp:include flush="true" page="/workflow/flow.jsp">
			<jsp:param name="workflowId" value="<%=WorkflowConstants.PROTOCOL_DEFINE%>"/>
