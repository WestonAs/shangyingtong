...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>协议积分活动详细信息<span class="caption_title"> | <f:link href="/promotions/protocolDef/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>ID</td>
		...
		<div class="tablebox">
			...
			<thead>
			<tr>
			   <td align="center" nowrap class="titlebg">协议积分规则ID</td>
