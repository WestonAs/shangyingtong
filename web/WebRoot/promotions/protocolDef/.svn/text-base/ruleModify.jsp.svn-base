					 ...
					 -->
						...
						<tr>
							...
							<td height="30" colspan="1">
								...
								<input type="button" value="返回上级" name="escape" onclick="gotoUrl('/promotions/protocolDef/ruleList.do?promtRuleDef.promtId=${promtRuleDef.promtId}')" class="ml30" />
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_PROTOCOL_DEF_RULEMODIFY"/>
				</s:form>
