	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>${fn:amount(realAmt)}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/saleCardCancel/checkDetail.do?saleCardReg.saleBatchId=${saleBatchId}">明细</f:link>
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<f:workflow adapter="saleCardCancelAdapter" returnUrl="/saleCardCancel/checkList.do"><s:token name="_TOKEN_SALE_CARD_BAT_CHECK"/></f:workflow>
		</div>
