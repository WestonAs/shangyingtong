...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
				<td>
					<input type="checkbox" name="ids" value="${retransCardId}"/>
				</td>
				...
				<td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/retransCardReg/checkDetail.do?retransCardReg.retransCardId=${retransCardId}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="retransCardRegAdapter" returnUrl="/retransCardReg/checkList.do"><s:token name="_TOKEN_RETRANSCARDREG_CHECKLIST"/></f:workflow>
		</div>
