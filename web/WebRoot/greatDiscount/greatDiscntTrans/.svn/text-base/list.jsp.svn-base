...
<%--							<td><s:textfield name="greatDiscntTrans.cardIssuer" /></td>--%>
							<td align="right">卡号</td>
							<td><s:textfield name="greatDiscntTrans.cardId" /></td>
							<td align="right">交易类型</td>
							<td><s:select name="greatDiscntTrans.transType" list="greatDiscntTransTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name"></s:select></td>
						<tr>
							<td>&nbsp;</td>
					...
					<s:token name="_TOKEN_GREATDISCNTTRANS_LIST"/>
				</s:form>
			</div>
		...
		<thead>
		<tr>
			<td align="center" nowrap class="titlebg">原交易流水</td>
		...
		<tr>		
			...
			<td align="center" nowrap>${settAmt}</td>
		    ...
		    <td align="center" nowrap>
              <span class="redlink">
                <f:link href="/greatDiscount/greatDiscntTrans/detail.do?greatDiscntTrans.transSn=${transSn}">查看</f:link>
		  	  </span>
		    </td>
		</tr>
		</s:iterator>
