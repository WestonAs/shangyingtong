...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>高级折扣协议详细信息<span class="caption_title"> | <f:link href="/greatDiscount/greatDiscntProtclDef/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>折扣协议号</td>
				<td >
			...
			<tr>
				<td>发卡机构-持卡人折扣率</td>
				<td >
					${fn:perDecimal(greatDiscntProtclDef.issuerHolderDiscntRate)}
				</td>
				<td>发卡机构-商户折扣率</td>
				<td >
					${fn:perDecimal(greatDiscntProtclDef.issuerMerchDiscntRate)}
				</td>
			</tr>
			<tr>	
				<td >交易支付方式</td>
