...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption><s:text name="cardTypeCode.cardTypeName"/>充值撤销审核明细<span class="caption_title"> | <f:link href="/depositCancel/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>充值批次ID</td>
		...
		<div class="tablebox">
			...
			<form id="id_detail_bat" method="post" action="checkDetail.do?depositReg.depositBatchId=${depositReg.depositBatchId}">
			<table class="data_grid" width="100%" border="0" cellspacing="0" cellpadding="0">			
			<thead>
			<tr>
