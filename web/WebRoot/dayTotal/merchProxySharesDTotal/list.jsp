	...
	<body>
				...
				<s:form id="searchForm" action="list.do" cssClass="validate-tip">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td align="right">商户代理</td>
							<td>
							<s:if test="showCardMerchant">
							<s:select name="merchFeeDTotal.merchProxy" headerKey="" headerValue="--请选择--" list="cardMerchList" listKey="branchCode" listValue="branchName"></s:select>
							</s:if>
							<s:else>
							<s:textfield id="merchProxyName" name="merchFeeDTotal.merchProxyName"></s:textfield>
							</s:else>
							</td>
					...
					<s:token name="_TOKEN_MERCHPROXYSHARESDTOTAL_LIST"/>
				</s:form>
			</div>
		...
		<div class="tablebox">
			...
			<thead>
			   ...
			   <td align="center" nowrap class="titlebg">商户代理分润金额</td>
			...
			<tr>	
			  ...
			  <td align="center" nowrap>${merchProxyName}</td>
			  ...
			  <td align="right" nowrap>${fn:amount(merchProxyFee)}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<a href="javascript:openContextDialog('/dayTotal/merchProxySharesDTotal/detail.do?merchFeeDTotal.feeDate=${feeDate}&merchFeeDTotal.branchCode=${branchCode}&merchFeeDTotal.merchId=${merchId}&merchFeeDTotal.cardBin=${cardBin}&merchFeeDTotal.transType=${transType}');" />明细</a>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
