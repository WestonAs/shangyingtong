...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>礼品定义申请记录详细信息<span class="caption_title"> | <f:link href="/gift/giftCheckList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>礼品代码</td>
		  	...
		  	<tr>
				<td>生效日期</td>
				<td><s:date name="giftDef.effDate" format="yyyy-MM-dd HH:mm:ss" /></td>
				<td>失效日期</td>
				<td><s:date name="giftDef.expirDate" format="yyyy-MM-dd HH:mm:ss" /></td>
		  	</tr>
		  	<tr>
				<td>积分兑换类型</td>
