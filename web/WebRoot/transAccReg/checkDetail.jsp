...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>转帐申请详细信息<span class="caption_title"> | <f:link href="/transAccReg/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>卡转账ID</td>
			...
			<tr>
		  	...
		  	<tr>
				...
				<td>发卡机构</td>
				<td colspan="3">${transAccReg.cardBranch}-${fn:branch(transAccReg.cardBranch)}</td>
		  	</tr>
		  	<tr>
				<td>状态</td>
