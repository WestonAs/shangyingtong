...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id="id_checkForm" method="post" action="checkList.do">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${transAccId}"/></td>	
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/transAccReg/checkDetail.do?transAccReg.transAccId=${transAccId}">明细</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="transAccAdapter" returnUrl="/transAccReg/checkList.do"><s:token/></f:workflow>
		</div>
