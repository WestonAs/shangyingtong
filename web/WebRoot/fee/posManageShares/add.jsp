	...
	<head>
		...
		<script>
			$(function(){
				...
				Selector.selectBranch('id_posManageName', 'id_posManage', true, '32');
			...
			<s:form action="add.do" id="inputForm" cssClass="validate">
				<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						...
						<td>
							<s:hidden id="id_posManage" name="posManageShares.posManageId"
								cssClass="{required:true}"></s:hidden>
							<s:textfield  id="id_posManageName" cssClass="{required:true}"></s:textfield>
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费方式</td>
						<td>
							<s:select id="idFeeType" name="posManageShares.feeType" list="feeTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:hidden id="idCostCycleHidden" name="posManageShares.costCycle"></s:hidden>
						</td>
					</tr>
					<tr id="idFeeRateTr" style="display: none;">
						...
						<td>
							...
							<span class="field_tipinfo">费率最大14为整数，4位小数</span>
						</td>
					</tr>
				</table>
				...
				<s:token name="_TOKEN_POSMANAGESHARES_ADD"/>
			</s:form>
		</div>
