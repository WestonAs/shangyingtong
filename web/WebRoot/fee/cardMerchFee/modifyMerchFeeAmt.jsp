...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
			<s:form action="modifyMerchFeeAmt.do" id="inputForm" cssClass="validate">
				...
				<s:hidden name="merchFeeAmt.ulMoney"></s:hidden>
				...
				<s:token name="_TOKEN_CARDMERCHFEE_MODIFYMERCHFEEAMT"/>
			</s:form>
		</div>
