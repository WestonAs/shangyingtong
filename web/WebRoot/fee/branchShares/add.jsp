		...
		<script>
			...
			function check(){
				...
				for(i=0; i<count; i++){
					...
					if(!isDecimal($objR.val(), '7,4')){
						showMsg("费率必须为Num(7,4)");
						return false;
					}
				}
				for(i=1; i<count; i++){
			...
			<s:form action="add.do" id="inputForm" cssClass="validate">
				<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						...
						<td>
							<s:select id="idFeeType" name="branchShares.feeType" list="feeTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
					...
					<tr>
						...
						<td>
							...
							<s:hidden id="idCostCycleHidden" name="branchShares.costCycle"></s:hidden>
					...
					<tr id="idFeeRateTr" style="display: none;">
						...
						<td>
							<s:textfield id="idFeeRate" name="branchShares.feeRate" cssClass="{required:true, decimal:'7,4'}" disabled="disabeld"></s:textfield><span id="idFeeRateTip">%</span>
				...
				<s:token name="_TOKEN_BRANCHSHARES_ADD"/>
			</s:form>
		</div>
