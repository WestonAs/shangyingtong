	...
	<body>
		...
		<div class="userbox">
			...
			<s:form action="modify.do" id="inputForm" cssClass="validate">
				<s:hidden name="posProvShares.posProvId"></s:hidden>
				<s:hidden name="posProvShares.ulMoney"></s:hidden>
				<s:hidden name="posProvShares.costCycle"></s:hidden>
				<s:hidden id="id_feeType" name="posProvShares.feeType"></s:hidden>
				<s:hidden name="posProvShares.branchCode"></s:hidden>
				<table class="form_grid detail_tbl" width="100%" border="0" cellspacing="3" cellpadding="0">
					...
					<tr>
						...
						<td>
							${fn:branch(posProvShares.branchCode)}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">出机方</td>
						<td>
							${fn:branch(posProvShares.posProvId)}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费方式</td>
						<td>
							${posProvShares.feeTypeName}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费周期</td>
						<td>
							${posProvShares.costCycleName}
						</td>
					</tr>
					<s:if test="posProvShares.feeType==2 || posProvShares.feeType==3">
					<tr>
				...
				<s:token name="_TOKEN_POSPROVSHARES_MODIFY"/>
			</s:form>
		</div>
