...
<table class="form_grid" width="60%" border="0" cellspacing="3" cellpadding="0">
	<tr>
		...
		<td align="center" nowrap class="titlebg">${segment}</td>
		<td align="center" nowrap class="titlebg">${amtOrFeeRate}</td>
	</tr>
	<s:iterator value="chlFeeTemplateList" status="mcnStuts">
