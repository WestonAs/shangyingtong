		...
		<div class="userbox">
			...
			<s:form action="add.do" id="inputForm" cssClass="validate">
				<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					<caption>${ACT.name}<span class="caption_title">| <f:link href="/fee/chlFee/showAddTemplate.do">使用分支机构手续费模板？</f:link></span></caption>
					<tr>
					...
					<!--<tr>
						<td width="80" height="30" align="right">分支机构</td>
						<td>
							<s:select name="才" headerKey="" headerValue="--请选择--" list="branchList" listKey="branchCode" listValue="branchName" cssClass="{required:true}"></s:select>
					...
					--><tr>
						...
						<td>
							<s:select id="id_feeContent" name="chlFee.feeContent" onchange="queryCostCycleList()" list="feeContentList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
					...
					<tr>
						...
						<td>
							<select name="chlFee.costCycle" id="id_costCycle"
								class="{required:true}">
							</select>
					...
					<tr>
						...
						<td>
							<s:select id="idFeeType" name="chlFee.feeType" list="feeTypeList" headerKey="" 
				...
				<table class="form_grid" width="80%" border="0" cellspacing="3" cellpadding="0">
					<tr>
						...
						<td height="30" colspan="3"> 
							...
							<input type="button" value="返回" name="escape" onclick="gotoUrl('/fee/chlFee/list.do?goBack=goBack')" class="ml30" />
						</td>
					</tr>
				</table>
