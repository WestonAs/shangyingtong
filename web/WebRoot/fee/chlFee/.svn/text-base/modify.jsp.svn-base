	...
	<body>
		...
		<div class="userbox">
			...
			<s:form action="modify.do" id="inputForm" cssClass="validate">
				<s:hidden name="chlFee.branchCode"></s:hidden>
				<s:hidden name="chlFee.feeContent"></s:hidden>
				<s:hidden name="chlFee.ulMoney"></s:hidden>
				<table class="form_grid detail_tbl" width="100%" border="0" cellspacing="3" cellpadding="0">
					<tr>
						<td width="80" height="30" align="right">分支机构</td>
						<td>
							${chlFee.branchCode}-${fn:branch(chlFee.branchCode)}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费内容</td>
						<td>
							${chlFee.feeContentName}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费周期</td>
						<td>
							${chlFee.costCycleName}
						</td>
					</tr>
					<tr>
						<td width="80" height="30" align="right">计费类型</td>
						<td>
							<s:select id="idFeeType" name="chlFee.feeType" onchange="feeTypeChange();" list="feeTypeList" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
						</td>
					</tr>
					<s:if test="chlFee.feeType==3 || chlFee.feeType==4 || chlFee.feeType==6">
					<tr>
				...
				<s:token name="_TOKEN_CHLFEE_MODIFY"/>
			</s:form>
		</div>
