			...
			<s:form action="modify.do" id="inputForm" cssClass="validate">
				<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					<tr>
						...
						<td><s:textfield name="membAppointReg.cardIssuer"  cssClass="readonly" readonly="true" /></td>
						
						<td width="80" height="30" align="right">商户号码</td>
						<td><s:textfield name="membAppointReg.merNo"  cssClass="readonly" readonly="true" /></td>
						
						<td width="80" height="30" align="right">积分类型</td>
						<td><s:textfield name="membAppointReg.ptClass"  cssClass="readonly" readonly="true" /></td>
					</tr>
					<tr  id ="ptDiscntRate_tr" >
					    <td width="80" height="30" align="right">积分返利兑换率</td> 
						<td>
							<s:textfield id="id_ptDiscntRate" name="membAppointReg.ptDiscntRate" cssClass="{required:true}" ></s:textfield><span>%</span>
				...
				<s:token name="_TOKEN_MEMBAPPOINT_MODIFY"/>
			</s:form>
		</div>
