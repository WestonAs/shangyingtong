...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>会员定义记录详细信息<span class="caption_title"> | <f:link href="/vipCard/vipCardDef/membDefCheckList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>会员类型</td>
		  	...
		  	<tr>
		  		<td>绝对失效日期</td>
				<td><s:date name="membClassDef.mustExpirDate" format="yyyy-MM-dd HH:mm:ss" /></td>
				<td>审核状态</td>
