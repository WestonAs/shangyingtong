...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<f:js src="/js/biz/vipCard/membClassDefAdd.js"/>
				...
				<s:form action="add.do" id="inputForm" cssClass="validate">
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<tr>	
							...
							<td> 
								<s:textfield id="idMembLevel" name="membClassDef.membLevel" cssClass="{required:true}"/>
						...
						<tr>
							...
							<td>
								<s:select id="idMembUpgradeMthd" name="membClassDef.membUpgradeMthd" list="membUpgradeMthdTypeList" 
							...
							<td>
								<s:select id="idMembDegradeMthd" name="membClassDef.membDegradeMthd" list="membDegradeMthdTypeList" 
								headerKey="" headerValue="--请选择--" listKey="value" listValue="name" cssClass="{required:true}"></s:select>
								<span class="field_tipinfo">请选择方式</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:textfield name="membClassDef.mustExpirDate" onclick="WdatePicker({minDate:'%y-%M-%d'})" 
							...
							<td>
								...
								<s:radio list="#externalCardType" name="membClassDef.reserved1" />
							</td>
						</tr>
					</table>
					...
					<s:token name="_TOKEN_VIPCARDDEF_ADD"/>
				</s:form>
			</div>
