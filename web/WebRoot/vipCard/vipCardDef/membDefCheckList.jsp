...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- 数据列表区 -->
		<div class="tablebox">
			<form id="id_checkForm" method="post" action="membDefCheckList.do">
			...
			<tr>
			   ...
			   <td align="center" nowrap class="titlebg">审核状态</td>
			...
			<tr>
				<td>
					<input type="checkbox" name="ids" value="${membClass}"/>
				</td>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/vipCard/vipCardDef/membDefCheckDetail.do?membClassDef.membClass=${membClass}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="membDefAdapter" returnUrl="/vipCard/vipCardDef/membDefCheckList.do"><s:token name="_TOKEN_VIPCARDDEF_MEMBDEFCHECKLIST"/></f:workflow>
		</div>
