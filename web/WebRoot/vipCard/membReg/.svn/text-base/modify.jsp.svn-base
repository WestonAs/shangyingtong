			...
			<div class="contentb">
				<s:form action="modify.do" id="inputForm" cssClass="validate">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							<td width="80" height="30" align="right">注册编号</td>
							<td>
							<s:textfield name="membReg.membRegId" readonly="true" disabled="true"> </s:textfield>
							<s:hidden name="membReg.membRegId"></s:hidden>
							</td>
						...
						<tr>	
							...
							<td>
								<s:select id="membReg.sex" name="membReg.sex" list="sexTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" ></s:select>
						...
						<tr>
							...
							<td>
							<s:select id="membReg.education" name="membReg.education" list="educationTypeList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name" ></s:select>
								<span class="field_tipinfo">请选择学历</span>
							</td>
							
							<td width="80" height="30" align="right">会员类型</td>
							<td>
								<s:textfield name="membReg.membClass" cssClass="{required:true}  readonly" readonly="true"/>
						...
						<tr>
							...
							<td>
								<s:textfield name="membReg.cardId"  maxlength="19" cssClass="{required:true}  readonly" readonly="true"/>
								<span class="field_tipinfo">请输入卡号</span>
							</td>
							<td width="80" height="30" align="right">发卡机构</td>
							<td>
							<s:textfield name="membReg.cardIssuer" cssClass="{required:true}  readonly" readonly="true"/>
						...
						<s:if test='@gnete.card.service.mgr.BranchBizConfigCache@isNeedMembBankAcctInfo(loginBranchCode)'>
							...
							<tr>
								...
								<td>
									...
									<s:textfield id="accAreaName" name="formMap.accAreaName" cssClass="{required:true} readonly" readonly="true"/>
									<span class="field_tipinfo">请点击开户行名</span>
								</td>
						...
						<tr>
							...
							<td height="30" colspan="3">
								...
								<input type="button" value="返回" name="escape" onclick="gotoUrl('/vipCard/membReg/list.do?goBack=goBack')" style="margin-left:30px;" />
							</td>
						</tr>
					</table>
					<s:token name="_TOKEN_MEMBREG_MODIFY"/>
				</s:form>
			</div>
