...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>制卡申请详细信息<span class="caption_title"> | <f:link href="/makeCardApp/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
						<tr>
		...
		<jsp:include flush="true" page="/workflow/flow.jsp">
			<jsp:param name="workflowId" value="<%=WorkflowConstants.MAKE_CARD_APP%>"/>
			<jsp:param name="refId" value="${makeCardApp.id}"/>
		</jsp:include>
