...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${cancelCardId}"/></td>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/intgratedService/cancelCard/checkDetail.do?cancelCardReg.cancelCardId=${cancelCardId}">查看</f:link>
			  	</span>
			  </td>
			</tr>
			</s:iterator>
		...
		<f:workflow adapter="cancelCardAdapter" returnUrl="/intgratedService/cancelCard/checkList.do"><s:token name="_TOKEN_CANCELCARD_CHECKLIST"/></f:workflow>
