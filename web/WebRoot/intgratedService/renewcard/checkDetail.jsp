	...
	<body>
		<jsp:include flush="true" page="/layout/location.jsp"></jsp:include>
			...
			<table class="detail_grid" width="80%" border="1" cellspacing="0" cellpadding="1">
				<caption>换卡详细信息<span class="caption_title"> | <f:link href="/intgratedService/renewcard/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
				<tr>
					<td>换卡编号</td>
				...
				<tr>
					<td>发卡机构</td>	
					<td>${renewCardReg.cardBranch}-${fn:branch(renewCardReg.cardBranch) }</td>	
					<td>领卡机构</td>
					<td>${renewCardReg.appOrgId}-${fn:branch(renewCardReg.appOrgId)}${fn:dept(renewCardReg.appOrgId)}</td>	
				</tr>
				<tr>	
					<td>操作时间</td>
