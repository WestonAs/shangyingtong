		...
		<div id="contentDiv" class="userbox">
			...
			<div class="tablebox">
				...
				<tr>
				   ...
				   <td align="center" nowrap class="titlebg">挂失类型</td>
				...
				<tr>
				  <td><input type="checkbox" name="ids" value="${lossBatchId}"/></td>
				  <td nowrap>${lossBatchId}</td>
				  <td align="center" nowrap>${batName}</td>
				  ...
				  <td align="center" nowrap>
				  	<span class="redlink">
				  		<f:link href="/intgratedService/losscard/checkDetail.do?lossCardReg.lossBatchId=${lossBatchId}">查看</f:link>
				  </td>
				</tr>
				</s:iterator>
				</table>
			...
			<f:workflow adapter="lossCardAdapter" returnUrl="/intgratedService/losscard/checkList.do"><s:token name="_TOKEN_LOSS_CARD_CHECKLIST"/></f:workflow>
		</div>
