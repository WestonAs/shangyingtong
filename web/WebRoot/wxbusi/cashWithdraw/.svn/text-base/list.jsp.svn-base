...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="form_grid" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield id="id_WithdrawBillNo" name="wxWithdrawInfo.withdrawBillNo" cssClass="{digit:true}"  maxlength="12" />
							</td>
							<td align="right">卡号</td>
							<td>
								<s:textfield id="id_PayerCardId" name="wxWithdrawInfo.cardId" cssClass="{digit:true}"  maxlength="19" />
							</td>
							<td align="right">外部卡号</td>
							<td>
								<s:textfield id="id_ExtCardId" name="wxWithdrawInfo.extCardId" cssClass="{digit:true}"  maxlength="20" />
							</td>
						</tr>
						<tr>	
							<td align="right">提现日期</td>
							<td>
							...
							<td>
								<s:select name="wxWithdrawInfo.status" list="wxWithDrawStateList" headerKey="" headerValue="--请选择--" listKey="value" listValue="name"></s:select>
							</td>
							<td align="right">&nbsp;</td>
							<td align="right">&nbsp;</td>
						</tr>
		...
		<div class="tablebox">
			...
			<thead>
			<tr>
			   <td align="center" nowrap class="titlebg">提现单号</td>
			   <td align="center" nowrap class="titlebg">交易流水号</td>
			   ...
			   <td align="center" nowrap class="titlebg">订单金额</td>
			    <td align="center" nowrap class="titlebg">账户余额</td>
			   
			   <td align="center" nowrap class="titlebg">状态</td>
			   <td align="center" nowrap class="titlebg">提现日期</td>
			   <td align="center" nowrap class="titlebg">操作</td>
			</tr>
			</thead>
			<s:iterator value="page.data">
			<tr>
			  <td nowrap>${withdrawBillNo}</td>
			  <td align="center" nowrap>${transSn}</td>
			  <td align="center" nowrap>${cardId}</td>
			  <td align="center" nowrap>${extCardId}</td>
			  <td align="center" nowrap>${fn:amount(billAmount)}</td>
			  <td align="center" nowrap>${fn:amount(availBal)}</td>
			  
			  <td align="center" nowrap>${statuName}</td>
			  <td align="center" nowrap><s:date name="updateTime" format="yyyy-MM-dd HH:mm:ss"/></td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/wxbusi/cashWithdraw/detail.do?wxWithdrawInfo.withdrawBillNo=${withdrawBillNo}">明细</f:link>	
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<div class="userbox">
			...
			<div class="contentb">
				...
				<ul class="showli_div">
				<li class="showli_div">请至少输入提现单号/卡号/外部卡号。</li>
				</ul>
			</div>
			<b class="b4"></b><b class="b3"></b><b class="b2"></b><b class="b1"></b>
		</div>
