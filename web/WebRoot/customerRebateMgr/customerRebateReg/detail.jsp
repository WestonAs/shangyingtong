...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>客户返利详细信息<span class="caption_title"> | <f:link href="/customerRebateMgr/customerRebateReg/list.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>购卡客户ID</td>
				<td>${customerRebateReg.cardCustomerId}</td>
				<td>购卡客户名称</td>
			...
			<tr>
				...
				<td>发卡机构</td>
				<td>${customerRebateReg.cardBranch}-${fn:branch(customerRebateReg.cardBranch)}</td>
				<td>录入机构</td>
