...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablebox">
			...
			<tr>
			  <td><input type="checkbox" name="ids" value="${passwordResetRegId}"/></td>	
			  <td align="center" nowrap>${cardId}</td>
			  <td align="center" nowrap>${statusName}</td>
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/passwordReset/checkDetail.do?passwordResetReg.passwordResetRegId=${passwordResetRegId}">明细</f:link>
			  	</span>
			</tr>
			</s:iterator>
			</table>
		...
		<f:workflow adapter="passwordResetAdapter" returnUrl="/passwordReset/checkList.do"><s:token name="_TOKEN_PASSWORDRESETREG_CHECKLIST"/></f:workflow>
		</div>
