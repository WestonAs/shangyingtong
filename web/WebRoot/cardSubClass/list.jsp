				...
				<s:form action="list.do" id="searchForm" cssClass="validate-tip">
					<table id="form_grid" class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								<s:textfield name="cardSubClassDef.cardSubclass"/>
							</td>
						
							<td align="right">卡类型名称</td>
							<td>
								<s:textfield name="cardSubClassDef.cardSubclassName"/>
							</td>
							
							<td align="right">卡种</td>
							<td>
								<s:select name="cardSubClassDef.cardClass" list="cardTypeList" headerKey="" headerValue="--请选择--" listKey="cardTypeCode" listValue="cardTypeName">
								</s:select>
							</td>
						</tr>
						<tr>
							...
							<td height="30" colspan="4">
								...
								<f:pspan pid="makecardmgr_typemgr_add">
									<input style="margin-left:10px;" type="button" value="新增" onclick="javascript:gotoUrl('/cardSubClass/preShowAdd.do');" id="input_btn3"  name="escape" />
								</f:pspan>
							</td>
						</tr>
					</table>
		...
		<div class="tablebox">
			...
			<tr>
			  ...
			  <td align="center" nowrap>
			  	<span class="redlink">
			  		<f:link href="/cardSubClass/detail.do?cardSubClassDef.cardSubclass=${cardSubclass}">查看</f:link>
			  		<s:if test='"00".equals(status)'> <%-- 待审核状态 --%>
				  		<f:pspan pid="makecardmgr_typemgr_modify">
				  			<f:link href="/cardSubClass/showModify.do?cardSubClassDef.cardSubclass=${cardSubclass}">编辑</f:link>
				  		</f:pspan>
			  		</s:if>
			  		<f:pspan pid="makecardmgr_typemgr_modify">
			  			<f:link href="/cardSubClass/showModify.do?formMap.modifyType=expireDateOrMonths&cardSubClassDef.cardSubclass=${cardSubclass}">
			  		...
			  		&nbsp;&nbsp;&nbsp;&nbsp;
			  		<f:pspan pid="makecardmgr_typemgr_delete">
			  			<a href="javascript:submitUrl('searchForm', '/cardSubClass/delete.do?cardSubclass=${cardSubclass}', '确定要删除吗？');" />删除</a>
			  		</f:pspan>
			  	</span>
			  </td>
			</tr>
