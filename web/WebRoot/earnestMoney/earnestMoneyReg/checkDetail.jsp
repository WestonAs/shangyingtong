...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			<caption>风险保证金参数详细信息<span class="caption_title"> | <f:link href="/earnestMoney/earnestMoneyReg/checkList.do?goBack=goBack">返回列表</f:link></span></caption>
			<tr>
				<td>机构编号</td>
		...
		<table class="detail_grid" width="98%" border="1" cellspacing="0" cellpadding="1">
			...
			<tr>
				<td>保证金余额</td>
				<td>${riskMarginReg.remainRiskAmt}</td>
				<td>调整方向</td>
				<td>${riskMarginReg.adjDirectionName}</td>
				<td>调整金额</td>
				<td>${riskMarginReg.adjAmt}</td>
			</tr>
			<tr>
				<td>状态</td>
